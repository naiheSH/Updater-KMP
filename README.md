...
Only devices in the list of [device.json](https://github.com/naiheSH/Updater-KMP/blob/device-list/device.json) are supported use `AUTO` to complete automatically, other devices still need to manually enter the full system version.
